...
public class Calculators {
	...
	public static double alcoholByVolume(double originalGravity, double finalGravity) {
		return roundToDecimals(((1.05 * (originalGravity - finalGravity)) / finalGravity) / 0.79 * 100, 1);  
	}
}
