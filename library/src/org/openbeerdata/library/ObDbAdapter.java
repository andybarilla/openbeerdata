...
public class ObDbAdapter {
    ...
    public static final class YeastTypeColumns implements BaseColumns {
        public static final String TABLE = "yeast_types";
        public static final String TYPE = "type";
    }

    public static final class YeastColumns implements BaseColumns {
        public static final String TABLE = "yeasts";
        public static final String TYPE_ID = "type_id";
        public static final String SUPPLIER = "supplier";
        public static final String NAME = "name";
        ...
        public static final String ALCHOLOL_TOLERANCE = "alcohol_tolerance";
        public static final String NOTES = "notes";
    }
    ...
    public Cursor getYeastTypeCursor() {
        SQLiteQueryBuilder queryBuilder = new SQLiteQueryBuilder();
        queryBuilder.setTables(YeastTypeColumns.TABLE);
        String[] asColumnsToReturn = new String[] { YeastTypeColumns._ID,
                YeastTypeColumns.TYPE };

        Cursor cursor = queryBuilder.query(mDb, asColumnsToReturn, null, null,
                null, null, YeastTypeColumns.TYPE + " ASC");

        return cursor;
    }
    
    public Cursor getYeastCursor(String typeId) {
        SQLiteQueryBuilder queryBuilder = new SQLiteQueryBuilder();
        queryBuilder.setTables(YeastColumns.TABLE);
        String[] columnsToReturn = new String[] { YeastColumns._ID,
                YeastColumns.SUPPLIER, YeastColumns.SUPPLIER_NUMBER, YeastColumns.NAME };

        String[] selectionCriteria = new String[] { typeId };

        Cursor cursor = queryBuilder.query(mDb, columnsToReturn,
                YeastColumns.TYPE_ID + " = ?", selectionCriteria,
                null, null, YeastColumns.NAME + " ASC");

        return cursor;
    }

    public Cursor getYeastDetailCursor(String YeastId) {
        SQLiteQueryBuilder queryBuilder = new SQLiteQueryBuilder();
        queryBuilder.setTables(YeastColumns.TABLE);
        String[] columnsToReturn = new String[] { YeastColumns._ID,
                YeastColumns.SUPPLIER, YeastColumns.SUPPLIER_NUMBER, YeastColumns.NAME,
                YeastColumns.FLOCCULATION, YeastColumns.ATTENUATION, YeastColumns.ALCHOLOL_TOLERANCE,
                YeastColumns.TEMP_RANGE, YeastColumns.NOTES };

        String[] selectionCriteria = new String[] { YeastId };

        Cursor cursor = queryBuilder.query(mDb, columnsToReturn,
                YeastColumns._ID + " = ?", selectionCriteria,
                null, null, null);
